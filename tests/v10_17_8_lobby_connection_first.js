...
if(desktopBlock.indexOf('mobile_2k.glb')>desktopBlock.indexOf('root_locked.glb'))throw new Error('Desktop no longer tries the 2K boss first');
...
console.log('V10.17.8 LOBBY CONNECTION FIRST PASS · socket/room before 3D · 1K/2K adaptive boss · extension noise ignored');
